...
public sealed class UnitOfMeasureRepository(WarehouseDbContext dbContext, ILogger<UnitOfMeasureRepository> logger) : ReferenceRepository<UnitOfMeasure>(dbContext)
{
